#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# @Time    : 2018/9/19 上午10:09
# @Author  : huangjie
# @Site    : 
# @File    : web_framework.py
# @Software: PyCharm
...
class RequestHandler(object):
    ...
    async def __get_request_content(self, request):
        ...
        if self._has_var_kw_arg or self._has_kw_arg or self._required_kw_args:
            if request.method == 'POST':
                ...
                elif ct.startswitch('application/x-www-form-urlencoded') or ct.startswith('application/form-data'):
    ...
    async def __call__(self, request):
        print("2222")
        request_content = await self.__get_request_content()
